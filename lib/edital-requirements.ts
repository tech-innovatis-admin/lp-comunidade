// 8.1.8 (registro fotográfico) é gerado no envio a partir das fotos individuais
// ('foto'). Não entra na lista obrigatória de upload: a completude exige ≥ 3 fotos.
...
/** PDF único do registro fotográfico, gerado no POST /enviar a partir das fotos. */
export const EDITAL_PHOTOS_PDF_DOCUMENT_CODE = '8.1.8' as const;
...
export const EDITAL_MAX_BUDGET_ITEM_VALUE = 999_999_999;
...
export type EditalDocumentRequirementCode =
  ...
  | typeof EDITAL_PHOTOS_PDF_DOCUMENT_CODE
...
export function isEditalDocumentRequirementCode(value: string): value is EditalDocumentRequirementCode {
  return (
    ...
    value === EDITAL_PHOTOS_PDF_DOCUMENT_CODE ||
    value === EDITAL_PHOTO_DOCUMENT_CODE
  );
}

export function isAutoGeneratedDocumentCode(
  value: string
): value is typeof EDITAL_AUTO_GENERATED_DOCUMENT_CODE | typeof EDITAL_PHOTOS_PDF_DOCUMENT_CODE {
  return value === EDITAL_AUTO_GENERATED_DOCUMENT_CODE || value === EDITAL_PHOTOS_PDF_DOCUMENT_CODE;
}
